...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $queryaa = $client->request('GET', "https://gmxeqbapboztlivrkfcy.supabase.co/rest/v1/autorizacao_saida?select=*", [
        'headers' => [
            'apikey' => $apiKey,
    ...
    $response = $client->request('POST', 'https://gmxeqbapboztlivrkfcy.supabase.co/rest/v1/autorizacao_saida', [
        'headers' => [
            'apikey' => $apiKey,
            'Authorization' => "Bearer $apiKeySecret",
...
<body>
    ...
    <h1>Autorização de saída de estudante</h1>
    <br>
    </div>
    
    <form id='formfoda' action="home.php" method="post">
        <div id="container">
        <br>
        <div id="bordanome">
